...
import com.qacademico.qacademico.ViewHolder.ViewHolderHorario;

import net.cachapa.expandablelayout.ExpandableLayout;

import java.util.List;

public class AdapterHorario extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        //ViewHolderHorario holder = new ViewHolderHorario(view);
        return new ViewHolderHorario(view);
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        final ViewHolderHorario holder = (ViewHolderHorario) viewHolder;
        ...
        holder.recyclerView.setAdapter(new AdapterMateria(horario.getMateriasList(), context));
