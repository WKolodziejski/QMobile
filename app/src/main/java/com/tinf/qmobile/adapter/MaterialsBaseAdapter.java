...
public abstract class MaterialsBaseAdapter extends RecyclerView.Adapter<MaterialBaseViewHolder> {
    ...
    private final LongSparseArray<Long> downloading = DataBase.get().getMaterialsDataProvider().downloading;
                                ...
                                while (!selected.isEmpty()) {
                                    ...
                                    if (file.exists()) {
                                        if (file.delete()) {
                                            ...
                                            Toast.makeText(context, context.getString(R.string.toast_delete_file_fail), Toast.LENGTH_SHORT).show();
                                        }
                                    } else {
