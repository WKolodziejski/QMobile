...
public class ClassesAdapter extends RecyclerView.Adapter<CalendarViewHolder>
  ...
  private List<CalendarBase> getList(Bundle bundle) {
    ...
    LocalDate minDate = new LocalDate(firstClazz.getStartTime()).toDateTimeAtStartOfDay()
                                                                .dayOfMonth()
                                                                .withMinimumValue()
                                                                .toLocalDate();
    LocalDate maxDate = new LocalDate(lastClazz.getStartTime()).toDateTimeAtStartOfDay()
                                                               .dayOfMonth()
                                                               .withMaximumValue()
                                                               .toLocalDate();
