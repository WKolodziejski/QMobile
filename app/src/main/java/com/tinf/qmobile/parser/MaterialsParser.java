...
public class MaterialsParser extends BaseParser {
  ...
  public MaterialsParser(int page, int year, int period, boolean notify,
      ...
      while (classe.equals("conteudoTexto")) {
        ...
        try {
          QueryBuilder<Material> builder = materialsBox.query()
                                                       .equal(Material_.title, title,
                                                              CASE_INSENSITIVE).and()
                                                       .between(Material_.date, date,
                                                                date).and()
  ...
  private void sendNotification(Material material) {
    ...
    NotificationUtils.show(
        String.format(Locale.getDefault(),
                      App.getContext()
                         .getResources()
                         .getString(R.string.notification_material_title),
