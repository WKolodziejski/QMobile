...
public class CalendarParser extends BaseParser {
  ...
  public CalendarParser(int page, int year, int period, boolean notify,
  ...
  public void parse(Document document) {
    ...
    for (int i = 0; i < months.size(); i++) {
      ...
      if (i == 0) {
        Element yearStart = document.getElementsByTag("table")
                                    .get(6)
        ...
        Element yearEnd = document.getElementsByTag("table")
                                  .get(6)
                                  .getElementsByTag("table")
                                  .get(4)
                                  .getElementsByTag("td")
