...
public class ScheduleViewFragment extends Fragment {
  ...
  private void setText() {
    ...
    binding.title.setText(
        schedule.getTitle().isEmpty() ? getString(R.string.event_no_title) : schedule.getTitle());
    binding.startTime.setText(
        start.getDay().getDisplayName(TextStyle.FULL, Locale.getDefault()) + "・" +
    ...
    if (!end.equals(start)) {
      binding.startTime.append(
          " ー " + String.format(Locale.getDefault(), "%02d:%02d", end.getHour(), end.getMinute()));
    }
