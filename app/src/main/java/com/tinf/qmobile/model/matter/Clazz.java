...
public class Clazz extends EventBase implements Queryable {
  ...
  public Clazz(long date_, int classesCount_, int absences_, String teacher_, String content_,
               Period period) {
  ...
  public String getContent() {
    return content_ == null ? App.getContext().getResources().getString(R.string.class_no_content)
                            : content_.isEmpty() ? App.getContext()
                                                      .getResources()
                                                      .getString(R.string.class_no_content)
                                                 : content_;
  }
  ...
  public String getTitle() {
    return super.getTitle() == null ? App.getContext()
                                         .getResources()
                                         .getString(R.string.class_no_content)
                                    : super.getTitle().isEmpty() ? App.getContext()
                                                                      .getResources()
                                                                      .getString(
                                                                          R.string.class_no_content)
                                                                 : getContent();
  }
