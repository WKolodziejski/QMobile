...
public class PerformanceChart extends AbstractChartView implements ColumnChartDataProvider {

  private static final String TAG = "ColumnChartView";
  private ColumnChartData data;
  private ColumnChartOnValueSelectListener onValueTouchListener =
      new DummyColumnChartOnValueSelectListener();

  public PerformanceChart(Context context) {
    this(context, null, 0);
  }

  public PerformanceChart(Context context, AttributeSet attrs) {
    this(context, attrs, 0);
  }

  public PerformanceChart(Context context, AttributeSet attrs, int defStyle) {
