...
public class MultipleItemDivider extends RecyclerView.ItemDecoration {
    ...
    public MultipleItemDivider(Context context, int margin) {
        final TypedArray styledAttributes = context.obtainStyledAttributes(ATTRS);
        divider = styledAttributes.getDrawable(0);
        padding = Design.dpiToPixels(context, margin);
